...
#pathIn = 'hdfs://spark5-master:9000/user/k8s/test-20231113/k8s-api-resource-avoid-multiple/'
pathIn = 'hdfs://spark5-master:9000/user/k8s/test-20231120/k8s-api-resource-avoid-multiple-total-8/'
#pathIn = 'hdfs://spark5-master:9000/user/k8s/large-20231221/k8s-api-resource-avoid-multiple-split/2023-03/'

#pathIn = 'hdfs://spark5-master:9000/user/k8s/large-20231221/k8s-api-resource-avoid-multiple-total/'


#pathOut = 'hdfs://spark5-master:9000/user/k8s/test-20231113/k8s-api-resource-create-vertex-edge/'
pathOut = 'hdfs://spark5-master:9000/user/k8s/test-20231120/k8s-api-resource-create-vertex-edge-total-8/'
...
cmd = cmdPrefix + ' create_vertex_edge_v2.py ' + pathIn + ' ' + pathOut
